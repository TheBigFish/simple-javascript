...
const pro1 = new myPromise((resolve)=>{setTimeout(function () {
    resolve(100);
},2000);});
const pro = new myPromise((resolve)=>{setTimeout(function () {
    resolve(pro1);
},1000);});
pro.then(data => console.log('resolve' + data)).then(null, err => {console.log('reject' + err);});